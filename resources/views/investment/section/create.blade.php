                                            ...
                                            <div class="card-header-action">
                                                <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-menu" style="background-color: rgb(53, 60, 72);">
                                                    <a href="{{ route('section.Create') }}" class="dropdown-item has-icon text-success"><i class="fas fa-eye"></i> اضافة</a>
                                                ...
                                                <a href="{{ route('section') }}" class="btn btn-primary">ادارة القطاعات</a>
                                              </div>
