                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-action">
                                            ...
                                            <a href="{{ route('side') }}" class="btn btn-primary">ادارة
                                                طلبات الجهة</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input style="height: calc(2.25rem + 6px);" type="text"
                                                    class="form-control"
                                                    value="{{ $request->subCat->name ?? 'لايوجد' }}" disabled>
                                            </div>
                                            <div class="form-group col-md-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group col-md-12">
                                            <form class="needs-validation" novalidate=""
                                                action="{{ route('side.store') }}" method="POST"
                            ...
                            <div class="col-6 col-md-6 col-lg-6" style="direction: rtl">
                                <div class="card card-primary">
                                    <div class="card-body">
                                        <h4> انشاء ملاحظة</h4>
                                        <form class="needs-validation" novalidate=""
                                            action="{{ route('side.note', $request->id) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group col-md-12">
