                        ...
                        <div class="row" style="direction: rtl">
                            <div class="col-12 col-md-12 col-lg-12">
                                ...
                                <form class="needs-validation" id="work_experience" novalidate=""
                                    action="{{ route('export.update',$export->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            ...
                                            <div class="card-header-action">
                                                ...
                                                <a href="{{ route('export') }}" class="btn btn-primary">كل الصادر</a>
                                              </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input style="height: calc(2.25rem + 6px);" type="number"
                                                        name="export_id" value="{{ $export->export_id }}"
